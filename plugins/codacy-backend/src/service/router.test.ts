...
import { CodacyFindings } from './codacyInfoProvider';
...
describe('createRouter', () => {
  ...
  describe('GET /instanceUrl', () => {
    const DUMMY_INSTANCE_KEY = 'myInstance';
    const DUMMY_INSTANCE_URL = 'http://codacy-internal.example.com';
    const DUMMY_INSTANCE_EXTERNAL_URL = 'http://codacy.example.com';
